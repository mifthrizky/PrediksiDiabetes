...
# 4. Ambil path dari environment variables
# Gunakan os.getenv() untuk membaca.
# Bagian kedua adalah nilai default JIKA variabel tidak ditemukan di .env
MODEL_PATH = os.getenv("MODEL_PATH", "ml_training/backend/models/diabetes_model_5_fitur.joblib")
SCALER_PATH = os.getenv("SCALER_PATH", "ml_training/backend/models/diabetes_scaler_5_fitur.joblib")
